var CanvasHeatmap = function (canvasElm, alphaMask, options) {
          ...
          //  var shadow = 'rgba(0, 0, 0, ' + _options.intensity + ')';
            ...
            if (points) {
                ...
                for (var i = 0, len = pairs.length; i < len; i++) {
                    ...
                    //_drawPoint(ctx, x, y, _options.radius, shadow);
                    ...
                    if (drawMultiple) {
                        if (x > mapWidth) {
                            ...
                            //_drawPoint(ctx, x2, y, _options.radius, shadow);
                        } else {
                            //draw right
                            x2 = x + mapWidth;
                            _drawPoint(ctx, x2, y, left, right, top, bottom);
            ...
            if (!window.Worker) {
                ...
                bgWorker = new Worker("../Assets/ColorizeWebWorker.js");
    ...
    //function _drawPoint(ctx, x, y, radiusInPixel, shadow) {
